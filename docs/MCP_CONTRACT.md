...
**Canonical target contract:** v2.2
...
The v2.2 generated public surface and activation gates are complete and frozen. The contract remains non-live until the runtime cutover gate is executed and verified; generation completion alone does not replace the production service.

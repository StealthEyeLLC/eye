...
builder.Services.AddSingleton<MissionChatAssociationStore>();
builder.Services.AddSingleton<RelayService>();
builder.Services.AddSingleton<CapabilityManifestService>();
...
builder.Services.AddSingleton<DesktopContextService>();
...
builder.Services.AddSingleton<ContextCaptureService>();
builder.Services.AddSingleton<MissionContinuationService>();

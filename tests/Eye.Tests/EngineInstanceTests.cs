...
public sealed class EngineInstanceTests
{
    ...
    public async Task BuiltEngine_HandshakesPingsAndStops()
    {
        ...
        try
        {
            ...
            Assert.Equal(["browser.dom_snapshot", "browser.download", "browser.evaluate", "browser.navigate", "browser.observe", "ui.act", "ui.observe", "ui.query"], instance.Handshake.SupportedOperationIds);
